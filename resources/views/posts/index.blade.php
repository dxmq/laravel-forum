            ...
            <div class="col-md-9 col-sm-9">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer" style="padding: 4px; background-color: #ffffff">
                        <span title="评论数"><i class="fa fa-commenting-o" aria-hidden="true"></i> {{ $post->comments_count }}</span>&nbsp;
                        <span title="点赞数"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> {{ $post->zans_count }}</span>&nbsp;
